...
export function control_function(class_name,func){
    var keys = [
        ...
        {action:"blur"  ,key:"input[type='number']."+class_name+"[id]"},
        {action:"blur"  ,key:"input[type='range']."+class_name+"[id]"},
        {action:"input" ,key:"input[type='number']."+class_name+"[id]"},
        {action:"input" ,key:"input[type='range']."+class_name+"[id]"},
        ...
        {action:"blur"  ,key:"."+class_name+"[id] input[type='number'][name]"},
        {action:"blur"  ,key:"."+class_name+"[id] input[type='range'][name]"},
        {action:"input" ,key:"."+class_name+"[id] input[type='number'][name]"},
        {action:"input" ,key:"."+class_name+"[id] input[type='range'][name]"},
        ...
        {action:"blur"  ,key:"."+class_name+"[id] .imitate_list[name] > input[type='number']"},
        {action:"blur"  ,key:"."+class_name+"[id] .imitate_list[name] > input[type='range']"},
        {action:"input" ,key:"."+class_name+"[id] .imitate_list[name] > input[type='number']"},
        {action:"input" ,key:"."+class_name+"[id] .imitate_list[name] > input[type='range']"},
        ...
        {action:"blur"  ,key:"."+class_name+"[id] .drop_lane[name] > input[type='number']"},
        {action:"blur"  ,key:"."+class_name+"[id] .drop_lane[name] > input[type='range']"},
        {action:"input" ,key:"."+class_name+"[id] .drop_lane[name] > input[type='number']"},
        {action:"input" ,key:"."+class_name+"[id] .drop_lane[name] > input[type='range']"},
        ...
        {action:"blur"  ,key:".imitate_list."+class_name+"[id] > input[type='number']"},
        {action:"blur"  ,key:".imitate_list."+class_name+"[id] > input[type='range']"},
        {action:"input" ,key:".imitate_list."+class_name+"[id] > input[type='number']"},
        {action:"input" ,key:".imitate_list."+class_name+"[id] > input[type='range']"},
        ...
        {action:"blur"  ,key:".imitate_list."+class_name+"[id] > * input[type='number'][name]"},
        {action:"blur"  ,key:".imitate_list."+class_name+"[id] > * input[type='range'][name]"},
        {action:"input" ,key:".imitate_list."+class_name+"[id] > * input[type='number'][name]"},
        {action:"input" ,key:".imitate_list."+class_name+"[id] > * input[type='range'][name]"},
        ...
        {action:"blur"  ,key:".drop_lane."+class_name+"[id] > input[type='number']"},
        {action:"blur"  ,key:".drop_lane."+class_name+"[id] > input[type='range']"},
        {action:"input" ,key:".drop_lane."+class_name+"[id] > input[type='number']"},
        {action:"input" ,key:".drop_lane."+class_name+"[id] > input[type='range']"},
        ...
        {action:"blur"  ,key:".drop_lane."+class_name+"[id] > * input[type='number'][name]"},
        {action:"blur"  ,key:".drop_lane."+class_name+"[id] > * input[type='range'][name]"},
        {action:"input" ,key:".drop_lane."+class_name+"[id] > * input[type='number'][name]"},
        {action:"input" ,key:".drop_lane."+class_name+"[id] > * input[type='range'][name]"},
